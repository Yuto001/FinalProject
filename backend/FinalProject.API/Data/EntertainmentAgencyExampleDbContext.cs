...
public partial class EntertainmentAgencyExampleDbContext : DbContext
{
    public EntertainmentAgencyExampleDbContext()
    {
    }

    public EntertainmentAgencyExampleDbContext(DbContextOptions<EntertainmentAgencyExampleDbContext> options)
        : base(options)
    {
    }
